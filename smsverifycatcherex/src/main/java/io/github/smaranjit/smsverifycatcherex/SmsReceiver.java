...
class SmsReceiver extends BroadcastReceiver {
    ...
    private String phoneNumberFilterEx;
        ...
        try {
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    if ((phoneNumberFilter != null && !phoneNumber.equals(phoneNumberFilter))||(phoneNumberFilterEx != null && !phoneNumber.contains(phoneNumberFilterEx))) {
                        return;
                    }
    ...
    public void setPhoneNumberFilterEx(String phoneNumberFilterEx) {
        this.phoneNumberFilterEx = phoneNumberFilterEx;
    }
